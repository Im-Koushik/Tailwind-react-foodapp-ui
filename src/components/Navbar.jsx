...
const Navbar = () => {
  ...
  return (
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
      ...
      {/* SearchBar */}
      <div className='items-center bg-gray-200 rounded-full flex px-2 w-[200px] sm:w-[400px] lg:w-[500px]'>
      ...
      <div
        className={
          nav
            ? "fixed bg-white top-0 left-0 h-screen w-[300px] z-10 duration-300"
            : "fixed bg-white top-0 left-[-100%] h-screen w-[300px] z-10 duration-300"
        }>
        <AiOutlineClose
          onClick={() => setNav(!nav)}
          size={30}
